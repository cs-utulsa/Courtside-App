...
def send_verification_email(email, user_id):
    ...
    content = Content("text/html", render_template('emails/verifyEmailEmail.html', url=url))
...
def send_forgot_password_email(email, user_id):
    ...
    content = Content("text/html", render_template("emails/forgotPasswordEmail.html", url=url))
